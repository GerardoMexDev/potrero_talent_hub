...
async function checkMendez() {
  console.log("Fetching Mendez data...");
  const res = await fetch(`https://v3.football.api-sports.io/players?search=Mendez&team=2348`, { headers });
