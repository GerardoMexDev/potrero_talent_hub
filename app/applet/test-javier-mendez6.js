  ...
  try {
    ...
    if (match) {
        ...
        if (pData.response && pData.response.length > 0) {
            ...
            console.log("No hay stats para 2025, probando 2024...");
            const pRes2 = await fetch(`https://v3.football.api-sports.io/players?id=${match.id}&season=2024`, { headers });
